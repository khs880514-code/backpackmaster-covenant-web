...
1. **`shrink-glb.bat`** 파일을 받습니다
   ([여기서 받기](https://raw.githubusercontent.com/khs880514-code/backpackmaster-covenant-web/claude/production-g-lgo5o8/tools/shrink-glb.bat) —
   마우스 오른쪽 → "다른 이름으로 링크 저장")
2. 줄이려는 `.glb` 파일들과 **같은 폴더**에 둡니다
3. **더블클릭**합니다

파일을 배치 파일 **위로 끌어다 놓아도** 됩니다.
